...
- [x] Bind the exact task, host, nonce, base/tree, local integration ref, and
  remote baseline.
- [x] Read the active membrane authority, HCM-3.5/HCM-3.6 packages, Phase-3
  strict-Clippy authority stops, and current Cargo/source truth.
- [x] Preserve the Phase-3-open and HCM3EXIT-P2-CLIPPY-001 boundary while
  documenting the narrowly authorized HCM-4.1 planning exception.
- [x] Freeze the owner/SDK/CLI/compiler target split and the posture

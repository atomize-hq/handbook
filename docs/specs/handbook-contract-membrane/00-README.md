...
accepted. P6 is implemented, independently review-clean, and accepted at
reviewed subject
`sha256:814a1899c282511e1c3a5d9bb464308dea87f3dfd47825799bcfb2b672d93a38`.
Descriptor-selected aggregate flow is the current owner; both bridges and
normal-path fixed selection authority are removed, and the preserved behavior
wall remains GREEN. Future implementation-task gate runtime remains deferred.

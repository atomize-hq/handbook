...
pub use author::template_library::{
    ...
    TemplateLibraryResolveError, TemplateLibraryResolveErrorKind, TemplateLibraryResolveRequest,
    TemplateLibrarySelection,
};
pub use author::{
    author_charter, author_project_context, author_project_context_from_input,
    is_unusably_vague_charter_text, normalize_charter_free_text,
    parse_charter_structured_input_yaml, parse_project_context_input_yaml,
    ...
    validate_charter_markdown, validate_charter_structured_input, validate_project_context_input,

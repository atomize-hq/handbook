use crate::profile_readiness::{
    map_inspection_reason, map_inspection_status, project_profile_readiness,
    ArtifactInspectionReason, ArtifactInspectionStatus, ProfileArtifactRow, ProfileCapabilityRow,
    ProfileConditionRow, RepositoryReadinessStatus,
};
use handbook_engine::{
...
pub struct DoctorCharterRow {
    ...
    pub canonical_status: ArtifactInspectionStatus,
    pub canonical_reason: ArtifactInspectionReason,
...
pub(crate) fn doctor(repo_root: impl AsRef<Path>) -> Result<DoctorReport, DoctorError> {
...
pub(crate) fn doctor_with_decisions(
    ...
    let charter = inspection
        ...
        .map(|artifact| {
            ...
            DoctorCharterRow {
                ...
                canonical_status: map_inspection_status(artifact.status()),
                canonical_reason: map_inspection_reason(artifact.reason()),
...
mod tests {
    use super::*;
    use handbook_engine::inspect_profile_repository_with_stability_hook;

...
This project is indexed by GitNexus as **system** (8178 symbols, 16790 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
